 ...
 * Quartz配置类
 * Created by zhaihuilin on 2017/9/24  10:09.
 */
@Configuration
public class QuartzConfigration {
     ...
     */
    @Bean(name ="jobDetail")
    public MethodInvokingJobDetailFactoryBean detailFactoryBean(BillsTask task) {// ScheduleTask为需要执行的任务
        ...
        /*
         * sayHello为需要执行的方法
         * 通过这几个配置，告诉JobDetailFactoryBean我们需要执行定时执行ScheduleTask类中的AutoCreateOrder方法
         */
        jobDetail.setTargetMethod("ClearingBillsTask");
        return jobDetail;
    }
    /**
     * attention:
    ...
    public CronTriggerFactoryBean cronJobTrigger(MethodInvokingJobDetailFactoryBean jobDetail) {
        ...
        tigger.setCronExpression("0 0 23 * * ?");// 初始时的cron表达式
